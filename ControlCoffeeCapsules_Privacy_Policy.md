...
ControlCoffeeCapsules (en adelante, "la aplicación") se compromete a proteger tu privacidad. Esta Política de Privacidad describe cómo recopilamos, usamos y protegemos tu información al utilizar nuestra aplicación.
...
. Datos de uso (tiempo de aplicación, progreso).
...
1. Mejorar la experiencia del usuario en el aplicación.
2. Solucionar problemas técnicos.
3. Analizar el rendimiento de la aplicación.
No vendemos ni compartimos tus datos con terceros.

# Servicios de terceros
La aplicación puede incluir integraciones con servicios de terceros (como Google Play Services). Estos servicios tienen sus propias políticas de privacidad, que recomendamos leer:
...
Podemos actualizar esta política ocasionalmente. Te notificaremos cualquier cambio importante a través de la aplicación o por otros medios razonables.
